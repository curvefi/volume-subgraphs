...
export function handleWithdraw(event: WithdrawEvent): void {
    let withdrawal = new LlammaWithdrawal(
        event.transaction.hash.concatI32(event.logIndex.toI32())
    )
