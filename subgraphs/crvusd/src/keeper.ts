...
import {Provide as ProvideEvent,
    Withdraw as WithdrawEvent,
    Profit as ProfitEvent} from "../generated/templates/PegKeeper/PegKeeper";
import {BigInt, log} from "@graphprotocol/graph-ts";

export function handleProvide(event: ProvideEvent): void {
    let provide = new Provide(
    ...
    let keeper = PegKeeper.load(event.address)
    if (keeper) {
